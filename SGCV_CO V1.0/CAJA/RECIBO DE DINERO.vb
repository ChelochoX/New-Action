...
Public Class RECIBO_DE_DINERO
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SGCV_CO_V1._0.RECIBO DE DINERO.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRECIBO_DE_DINERO
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RECIBO_DE_DINERO = New RECIBO_DE_DINERO()
        rpt.Site = Me.Site
        Return rpt
    End Function
