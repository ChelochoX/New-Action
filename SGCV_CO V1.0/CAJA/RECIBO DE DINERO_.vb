...
Public Class RECIBO_DE_DINERO_
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SGCV_CO_V1._0.RECIBO DE DINERO_.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRECIBO_DE_DINERO_
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RECIBO_DE_DINERO_ = New RECIBO_DE_DINERO_()
        rpt.Site = Me.Site
        Return rpt
    End Function
