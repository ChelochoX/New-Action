...
Public Class REPORTE_FACTURA_CREDITO
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "REPORTE FACTURA CREDITO.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SGCV_CO_V1._0.REPORTE FACTURA CREDITO.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_NUMERO_FACTURA() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedREPORTE_FACTURA_CREDITO
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As REPORTE_FACTURA_CREDITO = New REPORTE_FACTURA_CREDITO()
        rpt.Site = Me.Site
        Return rpt
    End Function
