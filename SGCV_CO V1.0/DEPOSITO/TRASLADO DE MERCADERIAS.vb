...
Public Class TRASLADO_DE_MERCADERIAS
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "TRASLADO DE MERCADERIAS.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SGCV_CO_V1._0.TRASLADO DE MERCADERIAS.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_ROTACION() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedTRASLADO_DE_MERCADERIAS
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As TRASLADO_DE_MERCADERIAS = New TRASLADO_DE_MERCADERIAS()
        rpt.Site = Me.Site
        Return rpt
    End Function
