...
Public Class CABECERA_CLIENTE
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SGCV_CO_V1._0.CABECERA CLIENTE.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCABECERA_CLIENTE
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CABECERA_CLIENTE = New CABECERA_CLIENTE()
        rpt.Site = Me.Site
        Return rpt
    End Function
