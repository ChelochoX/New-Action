...
Public Class RECIBO_DE_DINERO_DUPLICADO
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "RECIBO DE DINERO DUPLICADO.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SGCV_CO_V1._0.RECIBO DE DINERO DUPLICADO.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRECIBO_DE_DINERO_DUPLICADO
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RECIBO_DE_DINERO_DUPLICADO = New RECIBO_DE_DINERO_DUPLICADO()
        rpt.Site = Me.Site
        Return rpt
    End Function
