...
Public Class STOCK_POR_NOMBRE
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SGCV_CO_V1._0.STOCK POR NOMBRE.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedSTOCK_POR_NOMBRE
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As STOCK_POR_NOMBRE = New STOCK_POR_NOMBRE()
        rpt.Site = Me.Site
        Return rpt
    End Function
