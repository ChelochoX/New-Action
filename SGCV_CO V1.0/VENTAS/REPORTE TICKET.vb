...
Public Class REPORTE_TICKET
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SGCV_CO_V1._0.REPORTE TICKET.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedREPORTE_TICKET
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As REPORTE_TICKET = New REPORTE_TICKET()
        rpt.Site = Me.Site
        Return rpt
    End Function
