...
Public Class CUENTA_CLIENTE_SINPAGADO
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "CUENTA CLIENTE SINPAGADO.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SGCV_CO_V1._0.CUENTA CLIENTE SINPAGADO.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_COD_CLIENTE() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedCUENTA_CLIENTE_SINPAGADO
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CUENTA_CLIENTE_SINPAGADO = New CUENTA_CLIENTE_SINPAGADO()
        rpt.Site = Me.Site
        Return rpt
    End Function
