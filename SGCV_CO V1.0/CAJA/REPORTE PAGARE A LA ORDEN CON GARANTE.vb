...
Public Class REPORTE_PAGARE_A_LA_ORDEN_CON_GARANTE
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "REPORTE PAGARE A LA ORDEN CON GARANTE.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SGCV_CO_V1._0.REPORTE PAGARE A LA ORDEN CON GARANTE.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_NUMERO_TICKET() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedREPORTE_PAGARE_A_LA_ORDEN_CON_GARANTE
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As REPORTE_PAGARE_A_LA_ORDEN_CON_GARANTE = New REPORTE_PAGARE_A_LA_ORDEN_CON_GARANTE()
        rpt.Site = Me.Site
        Return rpt
    End Function
