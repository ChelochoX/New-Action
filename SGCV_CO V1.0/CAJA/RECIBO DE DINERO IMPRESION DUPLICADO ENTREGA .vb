...
Public Class RECIBO_DE_DINERO_IMPRESION_DUPLICADO_ENTREGA_
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "RECIBO DE DINERO IMPRESION DUPLICADO ENTREGA .rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SGCV_CO_V1._0.RECIBO DE DINERO IMPRESION DUPLICADO ENTREGA .rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_NUMERO_RECIBO() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedRECIBO_DE_DINERO_IMPRESION_DUPLICADO_ENTREGA_
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RECIBO_DE_DINERO_IMPRESION_DUPLICADO_ENTREGA_ = New RECIBO_DE_DINERO_IMPRESION_DUPLICADO_ENTREGA_()
        rpt.Site = Me.Site
        Return rpt
    End Function
