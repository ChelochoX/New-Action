...
Public Class CUENTA_ACTUAL
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SGCV_CO_V1._0.CUENTA ACTUAL.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCUENTA_ACTUAL
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CUENTA_ACTUAL = New CUENTA_ACTUAL()
        rpt.Site = Me.Site
        Return rpt
    End Function
