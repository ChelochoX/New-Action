...
Public Class RENDICION_DE_CAJA
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SGCV_CO_V1._0.RENDICION DE CAJA.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRENDICION_DE_CAJA
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RENDICION_DE_CAJA = New RENDICION_DE_CAJA()
        rpt.Site = Me.Site
        Return rpt
    End Function
