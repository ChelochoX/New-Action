...
Public Class REPORTE_FACTURA_CONTADO
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "REPORTE FACTURA CONTADO.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SGCV_CO_V1._0.REPORTE FACTURA CONTADO.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedREPORTE_FACTURA_CONTADO
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As REPORTE_FACTURA_CONTADO = New REPORTE_FACTURA_CONTADO()
        rpt.Site = Me.Site
        Return rpt
    End Function
